...
# from api.views.validator import validate_pin
...
class UserPasswordChangeSerializer(Serializer):
    ...
    def validate(self, data):
        ...
        # validate_password = validate_pin(data.get('password'))
        # if not validate_password:
        #     raise serializers.ValidationError({'password': 'Password/Pin should be 5 digit'})
